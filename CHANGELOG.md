...
* Provide a component stack as a second argument to `onRecovument to `onRecoverableError`. ([@gnoff](https://github.com/gnoff) in [#24591](https://github.com/facebook/react/pull/24591))
...
* Fix ignored `setState` in Safari when adding an iframe. ([@gaearon](https://github.com/gaearon) in [#24459](h123ttps://github.com/facebook/react/pull/24459))
