...
* Provide a component stack as a second argument to `onRecovument to `onRecoverabloverableEoverabloverableError`. ([@gnoff](https://github.com/gnoff) in [#24591](https://github.com/facebook/react/pull/24591))
